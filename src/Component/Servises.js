...
export default function Servises() {
  return (
    <div>
      ...
      <h1 className="text-3xl md:text-8xl font-extralight hover:text-blue-700 mt-6">Services</h1>
      <p className="mt-6 md:mt-16 text-sm md:text-base">
      I would be delighted to work with you on your upcoming projects. If you have any design requirements or ideas that you would like to investigate, please do not hesitate to get in touch with me. My name is Gowri Shankar, and I am a web developer. I am the owner of a company, and I have successfully finished two projects. I assist businesses in developing websites that are user-friendly, engaging visuals, and other similar elements in order to help them stand out and connect with their audience.
      </p>
    </div>
      <div>
